...
for freq in ev_sr_df['description'].unique():
    ...
    plt.savefig(r'C:\Users\Michael\Analysis\myRecordings_extra\21-07-01\Figures\spikes\probe_frequency\\'+'meanall_freq'+str(freq)+'.png')
...
#for unit in range(0,2):
    ...
    plt.savefig(r'C:\Users\Michael\Analysis\myRecordings_extra\21-07-01\Figures\spikes\probe_frequency\perneuron\2Hz\bytrial\\unit'+str(unit)+'.png')
    plt.close()
